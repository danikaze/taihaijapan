...
$RIMRAF frontend/sw/__temp # delete just in case it was left, to avoid errors

echo -e "${COLOR_MSG} * Packing web code...${COLOR_NC}"
$WEBPACK --config .webpack/frontend.prod.js

echo -e "${COLOR_MSG} * Building service workers...${COLOR_NC}"
$WORKBOX injectManifest workbox.config.js
$WEBPACK --config .webpack/sw.prod.js

echo -e "${COLOR_MSG} * Cleaning service workers...${COLOR_NC}"
$RIMRAF frontend/sw/__temp
